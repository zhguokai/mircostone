...
AmCharts.StockGraph = AmCharts.Class({
    inherits: AmCharts.AmGraph, construct: function (a) {
...
AmCharts.StockPanel = AmCharts.Class({
    inherits: AmCharts.AmSerialChart, construct: function (a) {
...
AmCharts.StockLegend = AmCharts.Class({
    inherits: AmCharts.AmLegend, construct: function (a) {
...
AmCharts.StackedBullet = AmCharts.Class({
    construct: function () {
        ...
        var b = {
            ...
            eventObject: a, graph: this.graph, date: this.date
